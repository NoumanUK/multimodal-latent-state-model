...
\noindent\textbf{Keywords:} multimodal variational inference; latent-state modelling; missing data; Product-of-Experts; Lorenz--96; forecasting; uncertainty.
...
% -----------------------------------------------------------------------------
% FIGURE 1 PLACEHOLDER: Model architecture / pipeline
% Recommended filename: figures/figure_01_model_overview.pdf
% Uncomment when the architecture figure is available.
% \begin{figure*}[t]
% \centering
% \includegraphics[width=0.98\textwidth]{figure_01_model_overview.pdf}
% \caption{Overview of the proposed Robust Temporal MVAE. Histories of three observation modalities and their binary masks are processed by modality-specific recurrent encoders. Gaussian experts are combined through a mask-aware Product-of-Experts posterior. The fused latent state reconstructs the current Lorenz--96 state and is recursively propagated by a residual latent transition for multi-horizon forecasting.}
% \label{fig:model}
% \end{figure*}
% -----------------------------------------------------------------------------
...
% FIGURE 2 -- generated by scripts/generate_publication_figures.py
\begin{figure}[t]
\centering
...
\IfFileExists{figures/figure_05_temporal_improvement.pdf}{%
  ...
  \fbox{\parbox[c][4.4cm][c]{0.82\linewidth}{\centering
  \textbf{Figure 5 placeholder}\\[4pt]
...
% OPTIONAL ALTERNATIVE / SUPPLEMENTARY FIGURE C.
% The existing script also generates figure_c_relative_improvement.pdf.
% Do not include both Figure 5 and Figure C in the main paper if they communicate
% essentially the same result. Figure C can be moved to supplementary material.
% \begin{figure}[t]
% \centering
% \includegraphics[width=0.96\linewidth]{figures/figure_c_relative_improvement.pdf}
% \caption{Relative Temporal improvement across all evaluated noise, missingness, and modality-availability conditions.}
% \label{fig:all-improvement}
% \end{figure}
...
The dataset used in this study is synthetically generated from Eq.~\eqref{eq:l96}; no proprietary experimental data are required. Source code and configuration files are intended to be made publicly available at: \texttt{https://github.com/NoumanUK}.
